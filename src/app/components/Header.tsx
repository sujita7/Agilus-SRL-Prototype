              ...
              <div className="flex items-center gap-1.5 w-full">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button className="flex shrink-0 items-center justify-center w-[38px] h-[38px] rounded border border-[#0076BC] text-[#0076BC] relative bg-white transition-transform active:scale-95">
                    ...
                    <span className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-red-500 text-white text-[8px] flex items-center justify-center rounded-full border border-white font-bold">0</span>
                  </button>
